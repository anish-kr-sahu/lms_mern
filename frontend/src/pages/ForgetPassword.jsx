     ...
     { step == 1 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <form className='space-y-4'>
            <div>
                ...
                <input id='email' type="email" className='mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[black] 'placeholder='you@example.com' required/>
            </div>
     ...
     {step == 2 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <form className='space-y-4'>
            <div>
                ...
                <input id='otp' type="otp" className='mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[black] 'placeholder='****' required/>
            </div>
     ...
     { step == 3 &&  <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <form className='space-y-4'>
            <div>
                ...
                <input id='password' type="password" className='mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[black] 'placeholder='*********' required/>
            </div>
            <div>
                <label htmlFor="confirm password" className='block text-sm font-medium text-gray-700'>Confirm Password</label>
                <input id='conform password' type="password" className='mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[black] 'placeholder='*********' required/>
            </div>
